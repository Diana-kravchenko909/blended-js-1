...
// const min = Math.floor(Math.random() * (max - min + 1)) + min;
...
function isAdult(age) {
  ...
  if (age >= 18) {
    ...
    return confirm('Вам менше 18 років. Підтвердіть, що ви хочете увійти.');
  }
}
...
function fizzBuzz(num) {
  for (let i = 1; i <= num; i++) {
    ...
    // Якщо умова не виконується, виводимо число.
    else {
      console.log(i);
    }
  }
